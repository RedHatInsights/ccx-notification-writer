...
COMPONENTS="ccx-data-pipeline ccx-insights-results ccx-redis dvo-writer ccx-smart-proxy ccx-notification-writer ccx-notification-service ccx-notification-db-cleaner notifications-backend notifications-aggregator notifications-engine insights-content-service ccx-mock-ams insights-content-template-renderer"  # space-separated list of components to load
